  ...
  return (
    <div className={styles.background}>
      ...
      <div className={styles.workshops} name="workshops">
        {/* <img className={styles.image} src={workshop} alt="WORKSHOP" /> */}
        ...
        <div className={styles.workshopGrid}>
          <WorkshopItem
            ...
            description="So, you got an amazing hackathon idea. But that's not enough to in it! In this workshop, we show you the five essential ingredients on how to ace a hackathon"
